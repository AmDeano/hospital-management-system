...
public abstract class AbstractEmployeeService<T extends Employee> implements EmployeeService<T> {
    ...
    protected AbstractEmployeeService(JpaRepository<T, Long> repository, RabbitTemplate rabbitTemplate) {
        this.repository = Objects.requireNonNull(repository, "repository required");
        this.rabbitTemplate = Objects.requireNonNull(rabbitTemplate, "rabbitTemplate required");
    }
    ...
    // Template methods for subclasses NB : to be abstract
