...
@Service
@Transactional
public class ReceptionistService extends AbstractEmployeeService<Receptionist> {

    private final ReceptionistRepository receptionistRepository;
    private final RabbitTemplate rabbitTemplate;
    
    public ReceptionistService(ReceptionistRepository receptionistRepository, RabbitTemplate rabbitTemplate) {
