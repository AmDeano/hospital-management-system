...
@Service
@Transactional
public class NurseService extends AbstractEmployeeService<Nurse> {
    ...
    public NurseService(NurseRepository nurseRepository,RabbitTemplate rabbitTemplate, RabbitConfig rabbitConfig) {
