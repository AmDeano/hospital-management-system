...
@Service
@Transactional
public class AdministrativeStaffService extends AbstractEmployeeService<AdministrativeStaff> {

    private final AdministrativeStaffRepository repository;
    private final RabbitTemplate rabbitTemplate;
    
    public AdministrativeStaffService(AdministrativeStaffRepository repository, RabbitTemplate rabbitTemplate) {
